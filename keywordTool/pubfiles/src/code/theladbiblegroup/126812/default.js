integration.meta = {
   'sectionID' : '126812',
   'siteName' : 'The Lad Bible - Desktop - (AU)',
   'platform' : 'desktop'
};
...
integration.on("adCallResult", function(e) {
	if (e.data.hasSkin) {
		...
		$("#header, .article__next-up, .advert, .takeover, .category__banner, footer, .carousel--ondark").css({
			"margin" : "0 auto",
			"max-width" : "980px"
		});
...
window.ISMPassback = function() {
   return "<script src=\"http://www.googletagservices.com/tag/js/gpt.js\">\ngoogletag.pubads().definePassback('/8493129/Passback_TLB_Landscape_1',[[728, 90], [970, 250]]).setTargeting(\"passback\", \"Inskin-TLB-AU-Desktop-LL1\").display();\n<\\script>";
};
