...
window.ISMPassback = function() {
   return "<script src=\"http://www.googletagservices.com/tag/js/gpt.js\">\ngoogletag.pubads().definePassback('/8493129/Passback_P52_Landscape_1',[[728, 90], [970, 250]]).setTargeting(\"passback\", \"Inskin-P52-AU-Desktop-PL1\").display();\n<\\script>";
};