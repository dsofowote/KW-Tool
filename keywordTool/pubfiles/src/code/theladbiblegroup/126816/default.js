integration.meta = {
   'sectionID' : '126816',
   'siteName' : 'The Sport Bible - Desktop - (AU)',
   'platform' : 'desktop'
};
...
window.ISMPassback = function() {
   return "<script src=\"http://www.googletagservices.com/tag/js/gpt.js\">\ngoogletag.pubads().definePassback('/8493129/Passback_TSB_Landscape_1',[[728, 90], [970, 250]]).setTargeting(\"passback\", \"Inskin-TSB-AU-Desktop-SL1\").display();\n<\\script>";
};