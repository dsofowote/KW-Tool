integration.meta = {
    'sectionID' : '129822',
    'siteName' : 'Girlstyle HK - (Publisher Booking) - Smartphone - ( HK )',
    'platform' : 'smartphone'
};
...
integration.on('adCallResult', function(e) {
    if (e.data.hasSkin) {
        ...
        stylesCSS += '.inskinLoaded #back-top{right: '+ integration.custom.PageSkinFrameSide +'px !important}';
        stylesCSS += '</style>'
