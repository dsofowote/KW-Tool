integration.meta = {
    'sectionID' : '129488',
    'siteName' : 'RojakLah - (PageLead) - Smartphone - ( MY )',
    'platform' : 'smartphone'
};
...
integration.on('adCallResult', function(e) {
    if (e.data.hasSkin) {
       ...
       integration.custom.headHeight = $(".nav-fixed").outerHeight();
       ...
       integration.custom.pl_scrollState2 = integration.custom.headHeight;
        ...
        $("#div-gpt-ad-1496036894259-5, #div-gpt-ad-1560239049757-0").css({"display":"none"});
        $('body').addClass('inskinLoaded');
        var stylesCSS = '<style type="text/css">';
        stylesCSS += '.inskinLoaded .ism-frame:nth-of-type(1){z-index: 20 !important}';
        stylesCSS += '.inskinLoaded .ism-frame:nth-of-type(3){z-index: 100000000 !important}';
        stylesCSS += '.inskinLoaded .ism-frame:nth-of-type(2){z-index: 100000001 !important}';
        stylesCSS += '</style>'
