integration.meta = {
    'sectionID' : '128838',
    'siteName' : 'Gentside - Smartphone - (FR)',
    'platform' : 'smartphone'
};
...
integration.on('adCallResult', function(e) {
    if (e.data.hasSkin) {
      ...
      if ($(".header").length == 1) {
        ...
        stylesCSS += '.inskinLoaded .mdc-layout-grid.home-slide__content {width: calc(100% - ' + integration.custom.FrameSideRight + 'px) !important; margin-left: 0;}';
        stylesCSS += '</style>'
