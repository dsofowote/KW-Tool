integration.meta = {
	'sectionID' : '128129',
	'siteName' : 'Pink News (wider layout) - Desktop - (INT) ',
	'platform' : 'desktop'
};
...
window.ISMPassback = function() {
	return "<script src='https://www.googletagservices.com/tag/js/gpt.js'> googletag.pubads().definePassback('/21627008189/Passbacks/Passback_Inskin_DT_Pagicles', [1, 1]).display();
</script>";
}; 
