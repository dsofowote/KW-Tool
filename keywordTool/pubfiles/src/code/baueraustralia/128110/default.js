integration.meta = {
   'sectionID' : '128110',
   'siteName' : 'Street Machine - Smartphone - (AU) ',
   'platform' : 'smartphone'
};
...
integration.on('adCallResult', function(e) {
    ...
    var headHeight = $(".masthead").height() + 6;
    $("#inskinanchor").css({
    		"top" : headHeight,
    		"position" : "relative"
    	});
...
window.ISMPassback = function() {
   return "<script src=\"https://www.googletagservices.com/tag/js/gpt.js\">googletag.pubads().definePassback(\"/13534306/StreetMachine\", [320, 50]).display();\n<\\script>";
};
