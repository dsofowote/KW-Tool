integration.meta = {
    'sectionID': '129318',
    'siteName': 'So Feminine - (HB All) - Headerbidding - (UK)',
...
integration.on('adCallResult', function (e) {
    if (e.data.hasSkin) {
        ...
        smartphoneIntegration = function () {
            ...
            stylesCSS += '.inskinLoaded #af-scrollspy, .inskinLoaded .af-lazyloaded{max-width:' + contentWidth + 'px;}';
            stylesCSS += '</style>';
