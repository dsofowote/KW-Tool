integration.meta = {
	'sectionID' : '127532',
	'siteName' : 'PC Gamer US - (Tablet) - (US)',
	'platform' : 'tablet'
};
	...
	if (e.data.hasSkin) {
		...
		var specialCSS;
			...
			if (e.data.productType == "PageSkinEdgeTablet" || e.data.format == "Pageskin Edge") {
				...
				specialCSS += "body.pageSkinDisplayed nav {margin-left:-20px !important;}";
...
window.ISMPassback = function() {
	return "<script src=\"https://www.googletagservices.com/tag/js/gpt.js\">\n    googletag.pubads().definePassback(\"/8644/Passback_PC_Gamer/Inskin_US\", [728, 90]).display();\n<\\script>";
};
