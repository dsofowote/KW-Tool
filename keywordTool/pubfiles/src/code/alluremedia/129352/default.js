integration.meta = {
    'sectionID' : '129352',
    'siteName' : 'Pedestrian - (Pagelead) - Smartphone - (AU)',
    'platform' : 'smartphone'
};
...
integration.on('adCallResult', function(e) {
    if (e.data.hasSkin) {
      ...
      integration.custom.pl_class = ".navbar-fixed-top.hide-header";
      ...
      integration.custom.closePos = integration.custom.headHeight;
        ...
        stylesCSS += '.inskinLoaded body, html{overflow-x: visible !important}';
        stylesCSS += '.inskinLoaded .navbar-default{overflow: visible}';
        stylesCSS += '</style>'
