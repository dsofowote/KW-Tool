integration.meta = {
    'sectionID' : '129866',
    'siteName' : 'The English Garden  - Smartphone - ( UK )',
    'platform' : 'smartphone'
};
...
integration.on('adCallResult', function(e) {
    if (e.data.hasSkin) {
        ...
        stylesCSS += '.inskinLoaded .api-column{width: calc(' + cwidth + 'px - 20px);}';
        ...
        stylesCSS += '.inskinLoaded .newFooter{padding-left: 10px;}';
        stylesCSS += '</style>'
