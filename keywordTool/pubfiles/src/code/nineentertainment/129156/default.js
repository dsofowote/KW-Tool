integration.meta = {
    'sectionID' : '129156',
    'siteName' : '9 Now - (Creative Approval) - Desktop - ( AU )',
    'platform' : 'desktop'
};
...
integration.on('adCallResult', function(e) {
    if (e.data.hasSkin) {
      $(".Header__Wrapper-b5cu1y-0, .Header__Wrapper-b5cu1y-1, .nk-demographics, .nk-footer").css({"max-width": "1170px", "margin": "0 auto"});
      $(".fefxbp").css({"max-width": "1170px"});
    }
});
