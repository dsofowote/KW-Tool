...
tests['desktop_platform'] = function() {
   ...
   var reg_win8Desk = /(?!.*Touch)Windows\sNT\s([6]{1,}([\.][2-3]{1,}))/igm;
   var reg_win10Desk = /.*(Windows NT 10.).*/igm;
   ...
   if (  
      ...
      reg_win8Desk.test( navigator.userAgent ) ||
      reg_win10Desk.test( navigator.userAgent ) ||
